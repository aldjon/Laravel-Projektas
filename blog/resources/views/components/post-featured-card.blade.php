        ...
        <div class="flex-1 flex flex-col justify-between">
            <header class="mt-8 lg:mt-0">
                ...
                <div class="mt-4">
                    ...
                    <span class="mt-2 block text-gray-400 text-xs text-align: center">
                        Paskelbta <time>{{ $post->created_at->diffForHumans() }}</time>
                    </span>
                </div>
                <div class="flex-1 lg:mr-8 text-blue-400" >
                    <a href="{{ asset('storage/' . $post->mfile) }}"> Darbo Failo Nuoroda! </a>
                </div>
            </header>
